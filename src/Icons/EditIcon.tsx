...
const EditIcon = ({ size = 20, color = 'black' ,onPress,disabled}: EditIconProps) => {
    return (
        <Svg width={size} height={size} fill='none' viewBox="0 0 24 24" onPress={onPress} opacity={disabled ? 0.5 : 1} disabled={disabled}>
